...
use QuantaQuirk\Session\SessionManager;
...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \QuantaQuirk\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \QuantaQuirk\Session\SessionManager  $manager
    ...
    protected function handleStatefulRequest(Request $request, $session, Closure $next)
    {
        ...
        // so that the data is ready for an application. Note that the QuantaQuirk sessions
        // do not make use of PHP "native" sessions in any way since they are crappy.
        $request->setQuantaQuirkSession(
     ...
     *
     * @param  string  $driver
     * @return \QuantaQuirk\Cache\Store
     */
